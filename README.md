...
## 1.2 架构演变过程：单机（集中式）架构->集群架构—>面向服务架构（SOA）—>微服务架构（MSA）
### 1.2.1 单机（集中式）架构
...
### 从部署角度来看：
- 集中式系统：集中式系统是指由一台或多台主计算机组成中心节点，数据集中存储于这个中心节点中，并且整个系统的所有业务单元都集中部署在这个中心节点上，系统所有的功能均由其集中处理
- 分布式系统：分布式系统是一个硬件或软件组件分布在不同的网络计算机上，彼此之间仅仅通过消息传递进行通信和协调的系统。服务化架构使搭建分布式系统成为了可能
